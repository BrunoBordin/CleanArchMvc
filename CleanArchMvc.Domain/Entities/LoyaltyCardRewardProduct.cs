...
{
    public sealed class LoyaltyCardRewardProduct : Entity
    {
        ...
        public LoyaltyCardRewardProduct(int loyaltyCardId, int productId)
        {
        ...
        public LoyaltyCardRewardProduct(int id, int loyaltyCardId, int productId, DateTime addedAt)
        {
