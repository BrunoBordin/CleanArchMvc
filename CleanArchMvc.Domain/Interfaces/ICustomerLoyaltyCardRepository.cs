...
namespace CleanArchMvc.Domain.Interfaces
{
    public interface ICustomerLoyaltyCardRepository
    {
        ...
        Task<CustomerLoyaltyCard> GetByCustomerAndLoyaltyCardAsync(int customerId, int loyaltyCardId, int storeId);
        ...
        Task<IEnumerable<CustomerLoyaltyCard>> GetByStoreAsync(int storeId);
